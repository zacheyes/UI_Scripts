...
def process_image(file_path, output_dir, canvas_size=(3000, 2200), margin=0):
    """
...
def main():
    parser = argparse.ArgumentParser(description="Process and crop room-style images to 3000x2200 with content auto-cropping.")
    ...
    if not args.input:
        print("\n--- Running Room Cropping Script (3000x2200) in Standalone Mode ---")
    ...
    output_dir = os.path.join(input_folder, "Processed_2200_Room")
