...
def main():
    parser = argparse.ArgumentParser(description="Process and crop room-style images to 3000x1688, scaling by height.")
    ...
    if not args.input:
        print("\n--- Running Room Cropping Script (3000x1688) in Standalone Mode ---")
    ...
    output_dir = os.path.join(input_folder, "Processed_1688_Room")
